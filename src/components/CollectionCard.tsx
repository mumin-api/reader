    ...
    return (
        ...
        >
            ...
            >
                ...
                <div className="absolute top-0 right-0 w-32 h-32 bg-emerald-500/5 rounded-bl-[4rem] transition-transform duration-700 group-hover:scale-125" />
                ...
                <div className="relative z-10">
                    <div className="flex justify-between items-start mb-6">
                        <div className="p-3 bg-emerald-500/10 rounded-2xl group-hover:bg-emerald-600 group-hover:text-white transition-colors duration-500">
                    ...
                    <div className="mb-4">
                        <h3 className="text-xl font-display font-bold mb-1 leading-tight group-hover:text-emerald-600 transition-colors">
                            {nameEnglish}
                        </h3>
                        <p className="text-2xl font-amiri opacity-40 group-hover:opacity-100 transition-opacity" dir="rtl">
                            {nameArabic}
                        </p>
                    </div>

                    <p className="text-sm opacity-60 line-clamp-2 mb-6 leading-relaxed">
                        {description}
                    </p>
