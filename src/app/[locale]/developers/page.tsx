                ...
                <div className="max-w-7xl mx-auto">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
                        <div className="space-y-8">
                            <div className="w-20 h-20 rounded-[2rem] bg-emerald-600 flex items-center justify-center shadow-2xl shadow-emerald-500/20">
                                <Cpu className="w-10 h-10 text-white" />
                            </div>
                            <h2 className="text-4xl md:text-5xl font-display font-bold">{t('api_title')}</h2>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                {[
                                    ...
                                    <div key={i} className="group p-6 rounded-[2.5rem] bg-[var(--card-bg)] border border-[var(--card-border)] shadow-sm hover:shadow-xl transition-all duration-300">
                            ...
                            <div className="flex flex-wrap gap-4 pt-4">
                                <a 
                                    ...
                                    className="px-8 py-4 rounded-full bg-emerald-600 text-white font-bold text-sm tracking-widest uppercase hover:scale-105 transition-all shadow-lg hover:shadow-emerald-500/30 flex items-center gap-2"
                                >
                            ...
                            <div className="relative">
                                <div className="absolute inset-0 bg-emerald-500/5 rounded-[3.5rem] rotate-3 translate-x-4 scale-[1.02]" />
                                <div className="relative glass-card rounded-[3.5rem] overflow-hidden border border-[var(--card-border)] shadow-2xl p-8 bg-black/90">
  ...
  "data": {
    ...
    "arabic": "الإيمان بضع وسبعون..."
            ...
            <section className="py-32 px-4 relative">
                <div className="max-w-7xl mx-auto">
                    <div className="bg-emerald-600 rounded-[4rem] p-12 md:p-20 overflow-hidden relative shadow-2xl shadow-emerald-500/40">
                        {/* Background blobs */}
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center relative z-10">
                            ...
                            <div className="relative lg:block hidden">
                                <div className="absolute inset-0 flex items-center justify-center blur-2xl opacity-20 bg-emerald-600" />
                                <div className="relative mx-auto w-[320px] aspect-[9/18.5] bg-[#1a1a1a] rounded-[3.5rem] p-3 shadow-2xl border-4 border-emerald-600/50">
                                    {/* Notch */}
                                    <div className="absolute top-0 left-1/2 -translate-x-1/2 w-32 h-7 bg-[#1a1a1a] rounded-b-3xl z-20" />
                                    <div className="h-full w-full bg-emerald-600/40 backdrop-blur-2xl rounded-[2.8rem] overflow-hidden flex flex-col items-center justify-center border border-white/5">
